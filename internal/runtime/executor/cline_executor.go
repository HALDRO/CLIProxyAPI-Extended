...
func (e *ClineExecutor) PrepareRequest(_ *http.Request, _ *coreauth.Auth) error {
	return nil
}

// HttpRequest executes an HTTP request with Cline credentials.
func (e *ClineExecutor) HttpRequest(ctx context.Context, auth *coreauth.Auth, req *http.Request) (*http.Response, error) {
	if req == nil {
...
func (e *ClineExecutor) Execute(ctx context.Context, auth *coreauth.Auth, req cliproxyexecutor.Request, opts cliproxyexecutor.Options) (resp cliproxyexecutor.Response, err error) {
	...
	body = applyPayloadConfigWithRoot(e.cfg, baseModel, to.String(), "", body, originalTranslated, payloadRequestedModel(opts, baseModel))
...
func (e *ClineExecutor) ExecuteStream(ctx context.Context, auth *coreauth.Auth, req cliproxyexecutor.Request, opts cliproxyexecutor.Options) (stream <-chan cliproxyexecutor.StreamChunk, err error) {
	token, baseURL := clineCredentials(auth)
	if token == "" {
...
func clineCredentials(a *coreauth.Auth) (token, baseURL string) {
	if a == nil {
		return "", ""
	}
	if a.Attributes != nil {
...
func (e *ClineExecutor) CountTokens(ctx context.Context, auth *coreauth.Auth, req cliproxyexecutor.Request, opts cliproxyexecutor.Options) (cliproxyexecutor.Response, error) {
	from := opts.SourceFormat
	to := sdktranslator.FromString("openai")

	baseModel := req.Model
	translatedReq, errTranslate := sdktranslator.TranslateRequestE(ctx, from, to, baseModel, bytes.Clone(req.Payload), false)
	if errTranslate != nil {
		return cliproxyexecutor.Response{}, fmt.Errorf("cline executor: translate request: %w", errTranslate)
	}
...
func (e *ClineExecutor) Refresh(ctx context.Context, auth *coreauth.Auth) (*coreauth.Auth, error) {
